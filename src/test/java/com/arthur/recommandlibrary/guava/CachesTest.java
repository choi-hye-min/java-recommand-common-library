...
public class CachesTest {
    ...
    public void cacheBuilderTest() throws InterruptedException {
        LoadingCache<String, Person> loadingCache = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<String, Person>() {
                           ...
                           public Person load(String key) throws Exception {
                               System.out.println("# CacheLoader Start - "+key);
                               Thread.sleep(1500);
        ...
        System.out.println(loadingCache.getUnchecked("P1000").toString()); // 캐시에서 가져옴

        Thread.sleep(3500); // 3.5초 대기 그동안 캐시가 사라지기때문에 CacheLoader에서 다시 불러온다

        System.out.println(loadingCache.getUnchecked("P1000").toString()); // personMap에서 가져옴
    }
}
